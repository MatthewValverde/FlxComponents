...
class ApplicationMain
{
	...
	{
		#if openfl
		flash.Lib.setPackage("OpenFL", "DisplayingABitmap", "org.openfl.samples.displayingabitmap", "1.0.0");
		...
		wx.App.boot(function()
		{
			...
			frame = wx.Frame.create(null, null, "Displaying a Bitmap", null, { width: 800, height: 600 });
